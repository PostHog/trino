...
final class TestOpaConfig
{
    ...
    void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("opa.policy.revision-uri", "https://opa.example.com/v1/data/trino/revision")
                ...
                .put("opa.max-outstanding-requests", "37")
                .buildOrThrow();
        ...
        OpaConfig expected = new OpaConfig()
                ...
                .setOpaPolicyRevisionUri(URI.create("https://opa.example.com/v1/data/trino/revision"))
                .setLogRequests(true)
