...
public class DuckLakeTransactionManager
{
    ...
    public DuckLakeMetadata get(ConnectorTransactionHandle transaction, ConnectorIdentity identity)
    {
    ...
    private class MemoizedMetadata
    {
        ...
        public synchronized DuckLakeMetadata get(ConnectorIdentity identity)
        {
            if (metadata == null) {
