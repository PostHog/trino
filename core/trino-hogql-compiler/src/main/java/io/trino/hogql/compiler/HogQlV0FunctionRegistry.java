...
final class HogQlV0FunctionRegistry
{
    private static final Map<String, FunctionCapabilityDefinition> FUNCTIONS = functions(
            ...
            rewrite("range", FunctionRewrite.RANGE, "array(bigint)", signature(1)),
            ...
            rewrite("toStartOfWeek", FunctionRewrite.START_WEEK, "timestamp", signature(1)),
            ...
            rewrite("and", FunctionRewrite.AND, "boolean", signature(2)),
            ...
            aggregateRewrite("groupArrayIf", FunctionRewrite.GROUP_ARRAY_IF, "array(any)", signature(2)),
