...
final class HogQlV0FunctionRegistry
{
    private static final Map<String, FunctionCapabilityDefinition> FUNCTIONS = functions(
            ...
            rewrite("_toDate", FunctionRewrite.CAST_DATE, "date", signature(1)),
            ...
            rewrite("convertCurrency", FunctionRewrite.CONVERT_CURRENCY, "decimal", signature(3), signature(4)),
            ...
            rewrite("or", FunctionRewrite.OR, "boolean", signature(2), variadicSignature(2)),
